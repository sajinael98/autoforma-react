...
import type { Control, SubmitHandler, UseFormGetValues, UseFormReturn, UseFormSetError, UseFormSetValue, UseFormSetValues } from "react-hook-form";
export type BuiltInFieldType = "text" | "number" | "checkbox" | "date" | "datetime" | "time";
...
export type FormFieldSchema = BaseFieldSchema | SelectFieldSchema | ObjectFieldSchema | ArrayFieldSchema;
...
export interface FormGeneratorProps {
    ...
    uiConfig?: UiConfig;
    validate?: Record<string, (args: {
        value: any;
        values: FormValues;
    }) => string | undefined>;
    onError?: (errors: Record<string, string>) => void;
    onDirty?: (isDirty: boolean) => void;
    onFieldChange?: Record<string, (helpers: {
        path: string;
        value: any;
    ...
    updateFieldSchema?: {
        [key: string]: (args: {
            ...
            values: FormValues;
        }) => (Partial<Omit<FormFieldSchema, "type" | "name" | "fields">> & Record<string, any>) | Promise<Partial<Omit<FormFieldSchema, "type" | "name" | "fields">> & Record<string, any>>;
    };
}
